...
i_mem = pyrtl.MemBlock(bitwidth=32, addrwidth=20, name='i_mem')
d_mem = pyrtl.MemBlock(bitwidth=32, addrwidth=20, name='d_mem')
rf    = pyrtl.MemBlock(bitwidth=32, addrwidth=32, name='rf')
...
if __name__ == '__main__':
    ...
    #ALU output data
    alu_out = pyrtl.WireVector(bitwidth=32, namne='alu_out')
